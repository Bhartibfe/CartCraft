  ...
  return (
    <div className="flex items-center justify-between text-sm h-[15vh] py-3 w-full border-b-[1px] border-b-zinc-200">
      <div className="w-[20%] md:w-[15%] h-full pl-3 md:pl-12 flex items-center justify-center md:justify-start">
        <img
          src={item?.image}
          className="h-[40%] w-[70%] md:h-[70%] md:w-[45%]"
          alt=""
        />
      </div>
      <p className="w-[33%] md:w-[35%] pl-3 pr-0 md:pl-4 md:pr-4 text-xs md:text-sm text-start">
        {item?.title?.slice(0, 40)}
      </p>
      <p className="w-[22%] md:w-[15%] text-center text-xs md:text-sm">
        $ {item?.price}
      </p>
